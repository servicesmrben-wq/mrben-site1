...
export const CITY_PAGES: CityPage[] = [
  {
    ...
    fr: {
      ...
      paragraphs: [
        ...
        "Pour planifier votre service à Lachute, utilisez le bouton « Obtenir une estimation gratuite » et décrivez vos besoins. Vous obtiendrez une réponse rapide, avec des recommandations adaptées à votre maison. Nous sommes prêts à vous aider à maintenir un extérieur propre, sécuritaire et accueillant tout au long de l’année, avec un service ponctuel et soigné.",
      ],
    },
    en: {
      ...
      paragraphs: [
        ...
        "To schedule service in Lachute, click the “Get a free estimate” button and tell us what you need. You’ll receive a fast reply with recommendations tailored to your home. We’re ready to keep your exterior clean, safe, and attractive year-round with punctual, detail-oriented service.",
      ],
    },
  },
  {
    ...
    en: {
      ...
      paragraphs: [
        ...
        "For service in Saint-Jérôme, click the “Get a free estimate” button and share a few details about your home or business. We’ll respond quickly with a tailored proposal. Our goal is a clean, safe, and attractive exterior with a smooth and professional client experience.",
      ],
    },
  },
  {
  ...
  },
  {
    ...
    fr: {
      ...
      paragraphs: [
        ...
        "Pour planifier un nettoyage extérieur à Mirabel, cliquez sur « Obtenir une estimation gratuite » et indiquez vos besoins. Nous vous répondrons rapidement avec des recommandations adaptées. Notre équipe est prête à prendre soin de vos vitres, gouttières et revêtement avec un service fiable et attentif.",
      ],
    },
    en: {
      ...
      paragraphs: [
        ...
        "To schedule exterior cleaning in Mirabel, click the “Get a free estimate” button and tell us what you need. We’ll reply quickly with recommendations tailored to your home. Our team is ready to care for your windows, gutters, and siding with reliable, attentive service.",
      ],
    },
  },
  {
    ...
    fr: {
      ...
      paragraphs: [
        ...
        "Pour votre maison à Blainville, cliquez sur « Obtenir une estimation gratuite » et décrivez votre projet. Nous vous répondrons rapidement avec une estimation et des recommandations adaptées. Notre équipe est prête à offrir un service attentif et un extérieur propre et accueillant toute l’année.",
      ],
    },
    en: {
      ...
      paragraphs: [
        ...
        "For your Blainville home, click the “Get a free estimate” button and describe your project. We’ll reply quickly with an estimate and tailored recommendations. Our team is ready to deliver attentive service and a clean, welcoming exterior all year long.",
      ],
    },
  },
  {
    ...
    fr: {
      ...
      paragraphs: [
        ...
        "Pour un nettoyage extérieur à Laval, cliquez sur « Obtenir une estimation gratuite » et précisez vos besoins. Nous vous répondons rapidement avec une estimation claire. Notre équipe est prête à offrir un service professionnel pour des vitres, gouttières et revêtements impeccables.",
      ],
    },
    en: {
      ...
      paragraphs: [
        ...
        "For exterior cleaning in Laval, click the “Get a free estimate” button and share your needs. We respond quickly with a clear estimate and next steps. Our team is ready to provide professional service for spotless windows, gutters, and siding.",
      ],
    },
  },
];
